...
func registerQUICOutbounds(registry *outbound.Registry) {
	...
	outbound.Register[option.NowhereOutboundOptions](registry, C.TypeNowhere, func(ctx context.Context, router adapter.Router, logger log.ContextLogger, tag string, options option.NowhereOutboundOptions) (adapter.Outbound, error) {
		return nil, C.ErrQUICNotIncluded
	})
}
